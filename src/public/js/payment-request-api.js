...
f.paymentRequest('#cc-form', {
    currency: 'USD',
    fieldMap: {
        'cardNumber': f.paymentRequest.details.cardNumber,
        'cardName': f.paymentRequest.details.payerName,
        'amount': f.paymentRequest.details.amount,
        'cardExpirationDate': f.SERIALIZERS.join([f.paymentRequest.details.expiryMonth, f.paymentRequest.details.expiryYear], "/"),
        'cardCvc': f.paymentRequest.details.cardSecurityCode,
    },
    hideSelector: ".hide-on-payment-request",
});
